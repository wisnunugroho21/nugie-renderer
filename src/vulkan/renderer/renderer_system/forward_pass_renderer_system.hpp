...
namespace NugieApp {
	class ForwardPassRendererSystem : public GraphicRendererSystem {
		public:
			ForwardPassRendererSystem(NugieVulkan::Device* device, std::vector<NugieVulkan::DescriptorSetLayout*> descriptorSetLayouts, 
