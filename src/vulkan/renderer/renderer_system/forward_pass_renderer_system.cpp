#include "forward_pass_renderer_system.hpp"
...
namespace NugieApp {
	ForwardPassRendererSystem::ForwardPassRendererSystem(NugieVulkan::Device* device, std::vector<NugieVulkan::DescriptorSetLayout*> descriptorSetLayouts, 
	...
	void ForwardPassRendererSystem::createPipeline() {
