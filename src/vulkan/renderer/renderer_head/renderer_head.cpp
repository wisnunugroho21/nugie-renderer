...
namespace NugieApp {
	RendererHead::RendererHead(NugieVulkan::Window* window, NugieVulkan::Device* device) : device{device}, window{window} {
	...
	void RendererHead::recreateSwapChain() {
	...
	void RendererHead::createDescriptorPool() {
		this->descriptorPool = 
	...
	void RendererHead::createCommandPool() {
	...
	void RendererHead::createSyncObjects() {
	...
	void RendererHead::createCommandBuffers() {
	...
	void RendererHead::resetCommandPool() {
		this->transferCommandPool->reset();
		this->graphicCommandPool->reset();
	}

	bool RendererHead::acquireFrame() {
	...
	NugieVulkan::CommandBuffer* RendererHead::beginRecordRenderCommand(uint32_t frameIndex, uint32_t imageIndex) {
	...
	NugieVulkan::CommandBuffer* RendererHead::beginRecordTransferCommand() {
		this->transferCommandBuffers[0]->beginReccuringCommand();
		return this->transferCommandBuffers[0];
	}

	NugieVulkan::CommandBuffer* RendererHead::beginRecordPrepareCommand() {
	...
	void RendererHead::submitRenderCommand() {
	...
	void RendererHead::submitTransferCommand() {
	...
	void RendererHead::submitPrepareCommand() {
		std::vector<VkSemaphore> waitSemaphores = {};
	...
	bool RendererHead::presentFrame() {
