...
namespace NugieVulkan {
    ...
    public:
        ...
        bool allocate(VkDescriptorSet *descriptor, const VkDescriptorSetLayout &descriptorSetLayout,
                      const std::vector<uint32_t> &variableSetCounts = {}) const;

        bool
        allocate(std::vector<VkDescriptorSet> &descriptors, std::vector<VkDescriptorSetLayout> &descriptorSetLayout,
                 const std::vector<uint32_t> &variableSetCounts = {}) const;
