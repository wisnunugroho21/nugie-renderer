...
namespace NugieVulkan {
  ...
  {
    this->createSampler(filterMode, addressMode, anistropyEnable, borderColor, compareOp, mipmapMode);
  }
  ...
  void Sampler::createSampler(VkFilter filterMode, VkSamplerAddressMode addressMode, VkBool32 anistropyEnable, 
