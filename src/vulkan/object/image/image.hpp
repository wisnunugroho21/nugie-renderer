...
namespace NugieVulkan
{
  ...
  class Image
  {
    public:
      ...
      void copyBufferToImage(CommandBuffer* commandBuffer, Buffer* srcBuffer, uint32_t srcOffset = 0, uint32_t dstMipLevel = 0, uint32_t dstLayer = 0);
      void copyImageToBuffer(CommandBuffer* commandBuffer, Buffer* destBuffer, uint32_t dstOffset = 0, uint32_t srcMipLevel = 0, uint32_t srcLayer = 0);
      void copyImageFromOther(CommandBuffer* commandBuffer, Image* srcImage, uint32_t srcMipLevel = 0, uint32_t srcLayer = 0, uint32_t dstMipLevel = 0, uint32_t dstLayer = 0);
      void copyImageToOther(CommandBuffer* commandBuffer, Image* dstImage, uint32_t srcMipLevel = 0, uint32_t srcLayer = 0, uint32_t dstMipLevel = 0, uint32_t dstLayer = 0);
