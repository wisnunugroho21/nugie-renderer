...
namespace NugieApp {
  ...
  ObjectBoundBox::ObjectBoundBox(uint32_t i, Object* o, std::vector<Primitive> &p, TransformComponent *t, std::vector<Vertex> &v) : BoundBox(i), object{o}, primitives{p}, transformation{t}, vertices{v} {
