...
glslc src/shader/buffer_cube.mesh -o build/shader/buffer_cube.mesh.spv --target-spv=spv1.4
glslc src/shader/simple.task -o build/shader/simple.task.spv --target-spv=spv1.4